...
// Validate ../../../app/api/my-parking/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/my-parking">> = Specific
  const handler = {} as typeof import("../../../app/api/my-parking/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../app/api/parking-data/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/parking-data">> = Specific
  const handler = {} as typeof import("../../../app/api/parking-data/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../../app/api/user-parking/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/user-parking">> = Specific
  const handler = {} as typeof import("../../../app/api/user-parking/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
